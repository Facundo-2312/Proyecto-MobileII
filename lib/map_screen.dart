  ...
  Future<void> _initializeApp() async {
    ...
    if (location != null && mounted) {
      setState(() {
        ...
        nearbyRestaurants = restaurantService.getNearbyRestaurants(location);
        _updateMarkers();
        isLoading = false;
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: !kIsWeb && !showList && !isLoading
          ...
          : null,
      bottomSheet: !kIsWeb && !showList && !isLoading ? _buildBottomPanel() : null,
    );
  }
                  ...
                  child: nearbyRestaurants.isEmpty
                      ...
                      : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final distance = restaurant.getDistanceInKm(
                              userLocation!,
                            );
